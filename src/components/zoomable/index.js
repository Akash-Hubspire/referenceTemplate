...
function Zoomable({
  ...
  const gesture = useMemo(() => {
    ...
    return Gesture.Race(
      Gesture.Simultaneous(doubleTap, tap),
      Gesture.Simultaneous(tap, flingLeft, flingRight, pan, pinch),
    );

    // only add prop dependencies
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [onTap, snapToNext, snapToPrevious, maximumZoomScale, minimumZoomScale]);
...
Zoomable.defaultProps = {
  snapToNext: undefined,
  snapToPrevious: undefined,
  onTap: undefined,
};
